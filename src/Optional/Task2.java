 ...
 * Каждая табличка представлена в виде списка Optional<String>, где элементы — либо конкретное слово,
 * либо Optional.empty(), если слово отсутствует (разобрать некоторые слова на табличках было невозможно).
