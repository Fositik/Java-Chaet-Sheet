package Exceptions.Throws.Task2;
...
import Exceptions.Throws.Task2.storage.PasswordMemoryStorage;
import Exceptions.Throws.Task2.storage.PasswordStorage;
import Exceptions.Throws.Task2.validators.NameValidator;
import Exceptions.Throws.Task2.validators.PasswordLengthValidator;
import Exceptions.Throws.Task2.validators.PasswordStrengthValidator;
...
class Practicum {
    ...
    private static void showUserPassword() {
        ...
        try {
            ...
            final String name = scanner.nextLine();
            if (name.isEmpty()) {
                throw new ValidateNameException("Ошибка валидации имени: ");
            }
            checkValidatorRules(nameValidators, name);
